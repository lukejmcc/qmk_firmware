...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [L0] = LAYOUT_2_shifts(
                ...
                KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, LT(1, KC_ESC), KC_SPC, KC_RCTL, MO(L1), KC_LEFT, KC_DOWN, KC_RIGHT),
        ...
        [L1] = LAYOUT_2_shifts(
                ...
                ____, XXXX, ____, ____, ____, ____, KC_INSERT, KC_HOME, KC_PGDN, KC_PGUP, KC_END, ____, ____, KC_PGUP, ____,
